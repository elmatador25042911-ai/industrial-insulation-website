        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20 text-white">
          <div className={`flex flex-col items-center text-center transition-all duration-1000 ${heroVis.visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            ...
            <div className="mb-8 sm:mb-10">
              <img
                src="https://cdn.poehali.dev/files/edba81dc-d9bf-440c-9977-07294fa1920d.png"
                alt="Т1 Изоляция"
            ...
            {/* H1 */}
            <h1 className="t-h1 text-white mb-5 max-w-4xl font-bold text-5xl">
              Теплоизоляция для инженерных систем и оборудования
            </h1>

            {/* Подзаголовок */}
            <p className="t-lead mb-10 max-w-xl text-white">Подбор и расчёты, поставка и монтаж теплоизоляционных конструкций на: трубопроводы, арматуру, оборудование, резервуары.
