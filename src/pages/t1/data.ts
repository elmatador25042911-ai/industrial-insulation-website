...
export const CERTIFICATES = [
  { icon: "Pipette",     title: "Теплоизоляция на основе вспененного каучука",   desc: "Для инженерных систем и промышленного оборудования", category: "Изоляция" },
  ...
  { icon: "Droplet",     title: "Антиконденсатные покрытия",                      desc: "Предотвращение образования конденсата",              category: "Покрытия" },
  { icon: "Wrench",      title: "Монтажные материалы / аксессуары",               desc: "Ленты, клеи, очистители и комплектующие",            category: "Аксессуары" },
  { icon: "AudioLines",  title: "Шумоизоляция",                                   desc: "Снижение шума инженерных и промышленных систем",     category: "Шум" },
  { icon: "Anchor",      title: "Опоры и подвесы",                                desc: "Элементы крепления трубопроводов и оборудования",    category: "Крепёж" },
];
