...
export const CERTIFICATES = [
  { title: "Теплоизоляция на основе вспененного каучука", desc: "Гибкие изоляционные материалы для трубопроводов и оборудования", category: "Изоляция" },
  { title: "Теплоизоляция из минеральной \"каменной\" ваты", desc: "Негорючие плиты, маты и цилиндры на основе базальтового волокна", category: "Изоляция" },
  { title: "Защитные покрытия",                            desc: "Кожухи, металлические оболочки и облицовочные системы",          category: "Покрытия" },
  { title: "Защитные материалы",                           desc: "Плёнки, фольга, мембраны для защиты изоляционного слоя",         category: "Материалы" },
  { title: "Термочехлы",                                   desc: "Съёмные изоляционные чехлы для арматуры и фланцев",              category: "Чехлы" },
  { title: "Антиконденсатные покрытия",                    desc: "Решения против образования конденсата на холодных поверхностях", category: "Покрытия" },
  { title: "Монтажные материалы / аксессуары",             desc: "Крепёж, ленты, клеи и комплектующие для монтажа",                category: "Аксессуары" },
  { title: "Шумоизоляция",                                 desc: "Звукопоглощающие и виброизоляционные материалы",                  category: "Шум" },
  { title: "Опоры и подвесы",                              desc: "Опорные конструкции и подвесные системы для трубопроводов",      category: "Крепёж" },
];
