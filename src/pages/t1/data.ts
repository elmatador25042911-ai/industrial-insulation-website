...
export const CERTIFICATES = [
  { icon: "Pipette",     title: "Теплоизоляция на основе вспененного каучука",   desc: "Для инженерных систем и промышленного оборудования", category: "Изоляция", iconRotate: 180 },
  ...
  { icon: "DropletOff",  title: "Антиконденсатные покрытия",                      desc: "Предотвращение образования конденсата",              category: "Покрытия" },
