...
const CATALOG_SHIP: { name: string; sub: string; img: string; href?: string }[] = [
  ...
  { name: "Монтажные материалы",       sub: "Ленты, клеи, очистители",               img: "https://cdn.poehali.dev/projects/666206ac-09b6-496e-92d3-ecbea5df546a/bucket/catalog/montajniemateriali-sud.jpg", href: "/catalog/sudostroenie/montazhnye-materialy" },
  ...
  { name: "Термочехлы",                sub: "Для оборудования и трубопроводов",       img: "https://cdn.poehali.dev/projects/666206ac-09b6-496e-92d3-ecbea5df546a/bucket/catalog/termochehol-sud.jpg", href: "/catalog/sudostroenie/termochekhly" },
  { name: "Антиконденсатные покрытия", sub: "Тепло- и влагозащита поверхностей",     img: "https://cdn.poehali.dev/files/fd19cb44-689d-42fb-a507-66e8b6bcbd0a.jpg", href: "/catalog/sudostroenie/antikondensatnye-pokrytiya" },
];
...
const CATALOG_INDUSTRY: { name: string; sub: string; img: string; href?: string }[] = [
  ...
  { name: "Защитные материалы",         sub: "Металл и полимерные решения",              img: "https://cdn.poehali.dev/projects/666206ac-09b6-496e-92d3-ecbea5df546a/bucket/catalog/zashitniemateriali-pgs.jpg", href: "/catalog/pgs/zashchitnye-materialy" },
  { name: "Термочехлы",                sub: "Для оборудования и трубопроводов",         img: "https://cdn.poehali.dev/projects/666206ac-09b6-496e-92d3-ecbea5df546a/bucket/catalog/termochehol-pgs.jpg", href: "/catalog/pgs/termochekhly" },
  { name: "Каменная вата",             sub: "Теплоизоляция для инженерных систем",      img: "https://cdn.poehali.dev/projects/666206ac-09b6-496e-92d3-ecbea5df546a/bucket/catalog/vata-pgs.jpg", href: "/catalog/pgs/kamennaya-vata" },
  { name: "Шумоизоляция",              sub: "Снижение шума оборудования и систем",      img: "https://cdn.poehali.dev/projects/666206ac-09b6-496e-92d3-ecbea5df546a/bucket/catalog/shumoizol-pgs.png", href: "/catalog/pgs/shumoizolyatsiya" },
  { name: "Опоры и подвесы",           sub: "Крепление трубопроводов и систем",         img: "https://cdn.poehali.dev/projects/666206ac-09b6-496e-92d3-ecbea5df546a/bucket/catalog/podves-pgs.jpg", href: "/catalog/pgs/opory-i-podvesy" },
];
