...
const CATALOG_INDUSTRY: { name: string; sub: string; img: string; href?: string }[] = [
  ...
  { name: "Термочехлы ИТШМИ ПАНЦИРЬ",  sub: "Съёмные тепло- и шумоизоляционные чехлы для арматуры, оборудования и трубопроводов на промышленных объектах и объектах гражданского строительства.", img: "https://cdn.poehali.dev/projects/666206ac-09b6-496e-92d3-ecbea5df546a/bucket/catalog/termochehol-pgs.jpg", href: "/catalog/pgs/termochekhly" },
