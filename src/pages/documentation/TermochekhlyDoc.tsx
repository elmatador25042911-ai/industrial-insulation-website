...
const CDN =
  "https://cdn.poehali.dev/projects/666206ac-09b6-496e-92d3-ecbea5df546a/bucket/tc-docs";

type Doc = { file: string; title: string };

const DOCS: Doc[] = [
  { file: "tc-01.jpg", title: "ПАНЦИРЬ.ИТШМИ — сертификат соответствия" },
  { file: "tc-02.jpg", title: "ИТШМИ.ПАНЦИРЬ — пожарные сертификаты Г1 / НГ" },
  { file: "tc-03.jpg", title: "ИТШМИ.ПАНЦИРЬ — сертификат СЕРТЭНЕРГО" },
  { file: "tc-04.jpg", title: "ИТШМИ.ПАНЦИРЬ чехлы — сертификат соответствия" },
  { file: "tc-05.jpg", title: "ИТШМИ.ПАНЦИРЬ чехлы — инструкция" },
  { file: "tc-06.jpg", title: "ИТШМИ.ПАНЦИРЬ чехлы — опросный лист" },
  { file: "tc-07.jpg", title: "ИТШМИ.ПАНЦИРЬ — гигиеническое экспертное заключение" },
];

const TermochekhlyDoc = () => {
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 lg:pt-32 pb-20 sm:pb-24 lg:pb-28">
            ...
            <nav className="flex items-center gap-2 mb-8 flex-wrap text-[13px] text-gray-400">
              ...
              <Icon name="ChevronRight" size={14} className="text-gray-600" />
              <span className="text-white">Термочехлы</span>
            </nav>
            ...
            <h1 className="cat-h1 text-white">
              <span className="text-orange-500">Термочехлы</span>
            </h1>
...
export default TermochekhlyDoc;
