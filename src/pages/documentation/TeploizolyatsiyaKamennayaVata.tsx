...
const CDN =
  "https://cdn.poehali.dev/projects/666206ac-09b6-496e-92d3-ecbea5df546a/bucket/kamvata-docs";

type Doc = { file: string; title: string };

const DOCS: Doc[] = [
  { file: "kamvata-01.jpg", title: "Экспертное заключение (маты)" },
  { file: "kamvata-02.jpg", title: "Экспертное заключение (цилиндры)" },
  { file: "kamvata-03.jpg", title: "Сертификат пожарной безопасности (цилиндры)" },
  { file: "kamvata-04.jpg", title: "Сертификат пожарной безопасности (маты)" },
  { file: "kamvata-05.jpg", title: "Сертификат соответствия НГ (маты и цилиндры)" },
  { file: "kamvata-06.jpg", title: "Сертификат соответствия НГ (цилиндры)" },
  { file: "kamvata-07.jpg", title: "Санитарно-эпидемиологическое заключение" },
  { file: "kamvata-08.jpg", title: "Сертификат соответствия ПАНЦИРЬ.ФЛОТ" },
  { file: "kamvata-09.jpg", title: "Гигиеническое экспертное заключение ПАНЦИРЬ.ФЛОТ" },
  { file: "kamvata-10.jpg", title: "Свидетельство РМРС" },
];

const TeploizolyatsiyaKamennayaVata = () => {
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 lg:pt-32 pb-20 sm:pb-24 lg:pb-28">
            ...
            <nav className="flex items-center gap-2 mb-8 flex-wrap text-[13px] text-gray-400">
              ...
              <span className="text-white">
                Теплоизоляция из минеральной "каменной" ваты
              </span>
            </nav>
...
export default TeploizolyatsiyaKamennayaVata;
