...
const CDN =
  "https://cdn.poehali.dev/projects/666206ac-09b6-496e-92d3-ecbea5df546a/bucket/zm-docs";

type Doc = { file: string; title: string };

const DOCS: Doc[] = [
  { file: "zm-01.jpg", title: "ПАНЦИРЬ покрытия — протоколы испытаний" },
  { file: "zm-02.jpg", title: "ПАНЦИРЬ покрытия — сертификат соответствия" },
  { file: "zm-03.jpg", title: "ПАНЦИРЬ.МБР — пожарный сертификат" },
  { file: "zm-04.jpg", title: "ПАНЦИРЬ.ОЗ оболочки — протокол испытаний" },
  { file: "zm-05.jpg", title: "ПАНЦИРЬ.ОЗ оболочки — сертификат соответствия" },
  { file: "zm-06.jpg", title: "ПАНЦИРЬ.ОЗ — сертификат соответствия" },
  { file: "zm-07.jpg", title: "ПАНЦИРЬ.ПВХ покрытие — пожарный сертификат" },
  { file: "zm-08.jpg", title: "ПАНЦИРЬ.СТХ.СБ — протокол испытаний" },
];

const ZashchitnyeMaterialyDoc = () => {
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 lg:pt-32 pb-20 sm:pb-24 lg:pb-28">
            ...
            <nav className="flex items-center gap-2 mb-8 flex-wrap text-[13px] text-gray-400">
              ...
              <Icon name="ChevronRight" size={14} className="text-gray-600" />
              <span className="text-white">Защитные материалы</span>
            </nav>
            ...
            <h1 className="cat-h1 text-white">
              Защитные <span className="text-orange-500">материалы</span>
            </h1>
...
export default ZashchitnyeMaterialyDoc;
