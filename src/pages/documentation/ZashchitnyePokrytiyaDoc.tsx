...
const CDN =
  "https://cdn.poehali.dev/projects/666206ac-09b6-496e-92d3-ecbea5df546a/bucket/zp-docs";

type Doc = { file: string; title: string };

const DOCS: Doc[] = [
  { file: "zp-01.jpg", title: "Выписка из реестра сертификатов соответствия" },
  { file: "zp-02.jpg", title: "Сертификат соответствия (обязательный)" },
  { file: "zp-03.jpg", title: "Сертификат соответствия" },
];

const ZashchitnyePokrytiyaDoc = () => {
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 lg:pt-32 pb-20 sm:pb-24 lg:pb-28">
            ...
            <nav className="flex items-center gap-2 mb-8 flex-wrap text-[13px] text-gray-400">
              ...
              <Icon name="ChevronRight" size={14} className="text-gray-600" />
              <span className="text-white">Защитные покрытия</span>
            </nav>
            ...
            <h1 className="cat-h1 text-white">
              Защитные <span className="text-orange-500">покрытия</span>
            </h1>
...
export default ZashchitnyePokrytiyaDoc;
