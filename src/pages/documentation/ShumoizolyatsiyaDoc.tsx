...
const CDN =
  "https://cdn.poehali.dev/projects/666206ac-09b6-496e-92d3-ecbea5df546a/bucket/shum-docs";

type Doc = { file: string; title: string };

const DOCS: Doc[] = [
  { file: "shum-01.jpg", title: "Информационное письмо" },
  { file: "shum-02.jpg", title: "Протокол акустических испытаний" },
  { file: "shum-03.jpg", title: "Протокол испытания" },
  { file: "shum-04.jpg", title: "Сертификат соответствия" },
  { file: "shum-05.jpg", title: "Согласие на использование товарного знака" },
  { file: "shum-06.jpg", title: "Технический лист — Звукоизол ФЛЕКС" },
  { file: "shum-07.jpg", title: "Технический лист — система звукоизоляции «Премиум АЛ»" },
  { file: "shum-08.jpg", title: "Технический лист — система звукоизоляции «Премиум»" },
  { file: "shum-09.jpg", title: "Технический лист — система звукоизоляции «Стандарт АЛ»" },
  { file: "shum-10.jpg", title: "Технический лист — система звукоизоляции «Стандарт»" },
  { file: "shum-11.jpg", title: "Экспертное заключение" },
];

const ShumoizolyatsiyaDoc = () => {
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 lg:pt-32 pb-20 sm:pb-24 lg:pb-28">
            ...
            <nav className="flex items-center gap-2 mb-8 flex-wrap text-[13px] text-gray-400">
              ...
              <Icon name="ChevronRight" size={14} className="text-gray-600" />
              <span className="text-white">Шумоизоляция</span>
            </nav>
...
export default ShumoizolyatsiyaDoc;
