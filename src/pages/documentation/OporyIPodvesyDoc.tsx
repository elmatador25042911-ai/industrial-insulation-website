...
const CDN =
  "https://cdn.poehali.dev/projects/666206ac-09b6-496e-92d3-ecbea5df546a/bucket/op-docs";

type Doc = { file: string; title: string };

const DOCS: Doc[] = [
  { file: "op-01.jpg", title: "СОП ПЕРИМЕТР — сертификат соответствия (подвесная система)" },
  { file: "op-02.jpg", title: "СОП ПЕРИМЕТР подвесы — технические условия (ТУ)" },
];

const OporyIPodvesyDoc = () => {
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 lg:pt-32 pb-20 sm:pb-24 lg:pb-28">
            ...
            <nav className="flex items-center gap-2 mb-8 flex-wrap text-[13px] text-gray-400">
              ...
              <Icon name="ChevronRight" size={14} className="text-gray-600" />
              <span className="text-white">Опоры и подвесы</span>
            </nav>
            ...
            <h1 className="cat-h1 text-white">
              Опоры и <span className="text-orange-500">подвесы</span>
            </h1>
...
export default OporyIPodvesyDoc;
