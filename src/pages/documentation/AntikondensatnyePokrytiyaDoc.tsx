...
const CDN =
  "https://cdn.poehali.dev/projects/666206ac-09b6-496e-92d3-ecbea5df546a/bucket/ak-docs";

type Doc = { file: string; title: string };

const DOCS: Doc[] = [
  { file: "ak-01.jpg", title: "ПАНЦИРЬ.АК — СТО РМРС" },
  { file: "ak-02.jpg", title: "ПАНЦИРЬ.АК — пожарный сертификат (1)" },
  { file: "ak-03.jpg", title: "ПАНЦИРЬ.АК — пожарный сертификат (2)" },
  { file: "ak-04.jpg", title: "ПАНЦИРЬ.АК — пожарный сертификат" },
  { file: "ak-05.jpg", title: "ПАНЦИРЬ.АК — сертификат соответствия" },
  { file: "ak-06.jpg", title: "ПАНЦИРЬ.АК (АК-У, АК-М, АК-Ф) — экспертное заключение" },
  { file: "ak-07.jpg", title: "ПАНЦИРЬ.АК антиконденсат — сертификат соответствия" },
  { file: "ak-08.jpg", title: "ПАНЦИРЬ.АК — декларация об отсутствии асбеста" },
];

const AntikondensatnyePokrytiyaDoc = () => {
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 lg:pt-32 pb-20 sm:pb-24 lg:pb-28">
            ...
            <nav className="flex items-center gap-2 mb-8 flex-wrap text-[13px] text-gray-400">
              ...
              <Icon name="ChevronRight" size={14} className="text-gray-600" />
              <span className="text-white">Антиконденсатные покрытия</span>
            </nav>
            ...
            <h1 className="cat-h1 text-white">
              Антиконденсатные <span className="text-orange-500">покрытия</span>
            </h1>
...
export default AntikondensatnyePokrytiyaDoc;
