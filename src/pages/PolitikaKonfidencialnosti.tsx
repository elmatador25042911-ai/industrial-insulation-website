          ...
          <article id="agreement" className="scroll-mt-32">
            ...
            <div className="doc-body space-y-4">
              <P>
                ...
                и нажимая кнопку отправки, свободно, своей волей и в своём интересе даю согласие Обществу
                с ограниченной ответственностью «Т1 ИЗОЛЯЦИЯ» (ООО «Т1 ИЗОЛЯЦИЯ», ИНН 7810939850,
                ОГРН 1227800017389, адрес: 196105, г. Санкт-Петербург, ул. Решетникова, д. 13, литера А,
                помещ. 24-Н) на обработку моих персональных данных на следующих условиях:
              </P>
              ...
              <UL
                items={[
                  ...
                  "название компании / организации;",
                  "текст сообщения / комментария;",
                  "IP-адрес и технические данные устройства и браузера.",
                ]}
              />
              ...
              <UL
                items={[
                  "обработка моей заявки / запроса;",
                  "связь со мной для уточнения деталей;",
                  "подготовка коммерческого предложения или расчёта;",
                  "консультирование по продукции и услугам Оператора;",
                  "заключение и исполнение договоров.",
                ]}
              />
              ...
              <H3>4. Способ обработки</H3>
              <P>С использованием средств автоматизации и без использования таких средств.</P>

              <H3>5. Срок действия согласия</H3>
              <P>
                До достижения целей обработки либо до момента отзыва согласия, но не более 5 (пяти) лет
                с момента предоставления согласия, если иное не потребуется по законодательству.
              </P>

              <H3>6. Отзыв согласия</H3>
              <P>
                Я вправе отозвать настоящее согласие, направив письменное уведомление на электронную почту{" "}
                <a href="mailto:t1izol@mail.ru" className="text-orange-400 hover:text-orange-300 transition-colors">
                  t1izol@mail.ru
                </a>
                . В этом случае Оператор прекратит обработку моих персональных данных, за исключением случаев,
                когда обработка необходима в соответствии с законодательством Российской Федерации.
              </P>

              <H3>7. Подтверждение</H3>
              <P>
                Нажимая кнопку отправки формы, я подтверждаю, что ознакомлен(а) с Политикой конфиденциальности,
                ...
                , и даю согласие на обработку персональных данных на условиях, указанных в настоящем Согласии.
              </P>
            </div>
          </article>
