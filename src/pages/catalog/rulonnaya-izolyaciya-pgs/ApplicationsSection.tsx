...
const APPLICATIONS: { icon: string; title: string; text: string }[] = [
  {
    icon: "Wind",
    title: "Воздуховоды",
    text: "Теплоизоляция воздуховодов и вентиляционных каналов инженерных систем зданий.",
  },
  {
    icon: "Snowflake",
  ...
  },
  {
    ...
    text: "Изоляция поверхностей резервуаров, баков и технологических ёмкостей на промышленных и береговых объектах.",
  },
  {
    icon: "CircleDot",
  ...
  },
  {
    ...
    text: "Применение на промышленных и технологических объектах.",
  },
];
