...
const CARDS: { icon: string; title: string; text: string }[] = [
  {
    ...
    text: "Рулонная изоляция применяется для теплоизоляции воздуховодов, вентиляционных каналов, резервуаров, трубопроводов и других инженерных поверхностей зданий.",
  },
  {
    icon: "Droplets",
