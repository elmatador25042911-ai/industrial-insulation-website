...
const MARKING_PARTS: { code: string; label: string }[] = [
  { code: "UNIONFLEX", label: "Бренд производителя" },
  { code: "06", label: "Толщина, мм" },
  { code: "1000", label: "Ширина, мм" },
  { code: "15", label: "Длина, м" },
  { code: "CM-PROM FORMA", label: "Исполнение покрытия" },
];
    ...
    <section className="relative overflow-hidden border-t border-white/5">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24">
        <div className="flex items-center gap-3 mb-3">
          ...
          <span className="cat-label text-orange-400/90">МАРКИРОВКА</span>
        </div>
          ...
          <div className="lg:col-span-7 relative overflow-hidden rounded-sm border border-white/10 bg-gradient-to-br from-[#141416] to-[#0c0c0e] p-7 sm:p-9">
            ...
            <div className="relative overflow-x-auto pb-2 mb-8">
              <div className="flex items-end flex-wrap gap-1.5 sm:gap-2 font-mono">
                <span className="text-gray-500 text-lg sm:text-xl pr-1">Рулон</span>
                <span className="text-white text-xl sm:text-3xl font-bold">UNIONFLEX</span>
                <span className="text-orange-400 text-xl sm:text-3xl font-bold">06</span>
                <span className="text-gray-500 text-xl sm:text-3xl">×</span>
                <span className="text-orange-400 text-xl sm:text-3xl font-bold">1000</span>
                <span className="text-gray-500 text-xl sm:text-3xl">-</span>
                <span className="text-orange-400 text-xl sm:text-3xl font-bold">15</span>
                <span className="text-white text-xl sm:text-3xl font-bold pl-2">CM-PROM FORMA</span>
              </div>
          ...
          <div className="lg:col-span-5">
            <div className="relative h-full min-h-[320px]">
              ...
              >
                ...
                />
                <img
                  src={rollImages.stdSingle01}
                  alt="Пример рулонной изоляции"
