        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5">
            ...
            <h2 className="cat-h2 text-white mb-6 max-w-3xl">
              Подбор шумоизоляции{" "}
              <span className="text-orange-500">под параметры объекта</span>
            </h2>
            <p className="text-gray-400 text-base sm:text-lg leading-[1.7] mb-10">
              Для подбора оптимальной шумоизоляции передайте параметры объекта:
              тип коммуникаций, диаметр, материал, условия эксплуатации и
              требования к уровню шумоподавления.
            </p>

            <ul className="space-y-3.5 mb-10">
              {[
                "Подбор конструкции под тип инженерных коммуникаций",
                "Расчёт по требуемому уровню шумоподавления и условиям эксплуатации",
                "Решение под нормативные требования по уровню шума",
              ].map((t) => (
              ...
              {submitted ? (
                ...
                <form
                  onSubmit={async (e) => {
                    ...
                    setLoading(true);
                    try {
                      await sendRequest({ ...data, source: "Шумоизоляция (ПГС)" });
                      setSubmitted(true);
                    } catch {
                ...
                >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Тип коммуникаций, диаметр, материал, условия эксплуатации, требуемый уровень шумоподавления..."
                      rows={4}
