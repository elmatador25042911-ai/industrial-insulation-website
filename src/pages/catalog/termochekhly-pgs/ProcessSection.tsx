...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    img: "https://cdn.poehali.dev/projects/666206ac-09b6-496e-92d3-ecbea5df546a/bucket/5f576a84-4a14-490e-bc27-13dd96f0757e.jpg",
  },
  {
    num: "06",
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24">
        <div className="max-w-3xl">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="cat-label text-orange-400/90">ПРОЦЕСС</span>
          </div>
