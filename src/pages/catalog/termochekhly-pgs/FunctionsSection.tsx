...
const FUNCTIONS: Func[] = [
  {
    ...
    text: "Ограничение тепловых потерь на арматуре, фланцевых соединениях, клапанах и других участках инженерных систем промышленных и гражданских объектов.",
  },
  {
    icon: "ShieldCheck",
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24">
        <div className="max-w-3xl">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="cat-label text-orange-400/90">ФУНКЦИИ</span>
          </div>
          <h2 className="cat-h2 text-white mb-5">
            Основные функции <span className="text-orange-500">термочехлов</span>
          </h2>
