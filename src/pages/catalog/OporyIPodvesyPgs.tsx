...
const OPORY_SPECS: SpecsData = {
  ...
  lineup: [
    { name: "СОП «ПЕРИМЕТР»", sub: "Опоры для трубопроводов" },
  ],
};
...
const PODVESY: ProductData = {
  ...
  description:
    "Подвесы Хотпайп S предназначены для крепления трубопроводов с подвесом к перекрытиям и несущим конструкциям. Конструкция обеспечивает надёжную фиксацию и снижает теплопотери в узле крепления.",
  advantages: [
    "Предотвращение образования «мостиков холода»",
...
const PODVESY_SPECS: SpecsData = {
  ...
  lineup: [
    { name: "Хотпайп S", sub: "Подвесы для трубопроводов" },
  ],
};
