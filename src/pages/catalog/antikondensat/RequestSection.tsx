...
const DATA_LIST = [
  "Тип поверхности: металл, бетон, кирпич или другое основание",
  "Площадь нанесения",
  "Температура поверхности",
  "Температура и влажность окружающей среды",
  "Место установки и условия эксплуатации",
  "Требуемое количество слоёв",
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="ak-lead text-gray-400 mb-8">
              ...
              можно определить применимость материала и ориентировочный объём
              поставки.
            </p>
              ...
              {submitted ? (
                ...
                <form
                  onSubmit={async (e) => {
                    ...
                    setLoading(true);
                    try {
                      await sendRequest({ ...data, source: "Антиконденсатные покрытия (судостроение)" });
                      setSubmitted(true);
                    } catch {
                ...
                >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Тип поверхности, площадь, температура, влажность, место установки, сроки..."
                      rows={4}
