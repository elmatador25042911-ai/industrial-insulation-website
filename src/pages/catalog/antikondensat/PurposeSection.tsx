    ...
    <section className="relative overflow-hidden border-t border-white/5">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ak-section">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          {/* Карточки */}
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-5 ak-grid">
            {CARDS.map((c) => (
              <article
                key={c.title}
          ...
          <div className="lg:col-span-5">
            <div className="relative">
              ...
              <div
                className="relative aspect-[4/5] overflow-hidden rounded-sm border border-white/10 shadow-[0_30px_80px_-20px_rgba(0,0,0,0.8)] bg-[#0c0c0e]"
              >
                <img
                  src={IMG}
