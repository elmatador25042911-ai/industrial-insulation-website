        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5">
            ...
            <h2 className="cat-h2 text-white mb-6 max-w-3xl">
              Подбор трубной изоляции под{" "}
              <span className="text-orange-500">инженерные системы объекта</span>
            </h2>
            <p className="text-gray-400 text-base sm:text-lg leading-[1.7] mb-10">
              Для подбора трубной изоляции передайте параметры объекта: тип инженерной
              системы, диаметр трубопровода, температурный режим, условия эксплуатации и
              требования к наружному покрытию.
            </p>
              ...
              {submitted ? (
                ...
                <form
                  onSubmit={async (e) => {
                    ...
                    setLoading(true);
                    try {
                      await sendRequest({ ...data, source: "Трубная изоляция (ПГС)" });
                      setSubmitted(true);
                    } catch {
                ...
                >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Тип объекта, диаметр трубопровода, температурный режим, объём, сроки..."
                      rows={4}
