...
const APPLICATIONS: { icon: string; title: string; text: string }[] = [
  {
    icon: "Ship",
    title: "Трубопроводы",
    text: "Системы водоснабжения, отопления и инженерных систем зданий.",
  },
  {
    icon: "Cog",
  ...
  },
  {
    icon: "Wind",
    title: "Вентиляция",
    text: "Изоляция воздуховодов и каналов вентиляционных систем.",
  },
  {
    icon: "Snowflake",
    title: "Кондиционирование",
    text: "Изоляция трасс кондиционирования для контроля конденсата в помещениях и отсеках.",
  },
  {
    icon: "Factory",
    title: "Технологические коммуникации",
    text: "Технологические линии и инженерные контуры промышленных и береговых объектов.",
  },
  {
    icon: "Anchor",
    title: "Промышленные объекты",
    text: "Применяется на промышленных и технологических объектах.",
  },
];
