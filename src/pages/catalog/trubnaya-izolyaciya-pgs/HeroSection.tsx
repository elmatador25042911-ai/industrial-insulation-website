      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 lg:pt-32 pb-20 sm:pb-24 lg:pb-28">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6 xl:col-span-7">
            <h1 className="cat-h1 text-white mb-7">
              Трубная изоляция
              <br />
            ...
            <p className="text-gray-200 text-lg sm:text-xl leading-relaxed max-w-2xl mb-5">
              Теплоизоляционные трубки из вспененного синтетического каучука для
              инженерных систем зданий, промышленных трубопроводов, вентиляции,
              кондиционирования, холодоснабжения и технологических коммуникаций.
            </p>

            <p className="text-gray-400 text-[15px] sm:text-base leading-relaxed max-w-2xl mb-10">
              Применяются на объектах промышленного и гражданского строительства для
              снижения теплопотерь, контроля образования конденсата и защиты
              трубопроводов от влаги и перепадов температур.
            </p>
          ...
          <div className="lg:col-span-6 xl:col-span-5">
            <div className="relative">
              ...
              >
                ...
                <img
                  src="https://cdn.poehali.dev/projects/666206ac-09b6-496e-92d3-ecbea5df546a/bucket/0870a889-4269-455a-afb0-ede1b30ea2f6.png"
