...
import CoatingsSection from "./rulonnaya-izolyaciya-pgs/CoatingsSection";
import SizesSection from "./rulonnaya-izolyaciya-pgs/SizesSection";
import MarkingSection from "./rulonnaya-izolyaciya-pgs/MarkingSection";
import RollTypesSection from "./rulonnaya-izolyaciya-pgs/RollTypesSection";
import TechnicalSpecsSection from "./rulonnaya-izolyaciya-pgs/TechnicalSpecsSection";
import RequestSection from "./rulonnaya-izolyaciya-pgs/RequestSection";
import HighDensitySection from "./shared/HighDensitySection";
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 lg:pt-32 pb-20 sm:pb-24 lg:pb-28">
            ...
            <div className="flex items-center gap-3 mb-8 flex-wrap">
              ...
              <span className="cat-label text-orange-400/90 leading-relaxed">
                КАТАЛОГ / ПРОМЫШЛЕННОЕ И ГРАЖДАНСКОЕ СТРОИТЕЛЬСТВО / РУЛОННАЯ ИЗОЛЯЦИЯ
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-6 xl:col-span-7">
                ...
                <p className="text-gray-200 text-lg sm:text-xl leading-relaxed max-w-2xl mt-7 mb-5">
                  Рулонная теплоизоляция из вспененного синтетического каучука для
                  инженерных систем зданий, промышленных объектов, воздуховодов,
                  резервуаров, вентиляции, кондиционирования и технологических поверхностей.
                </p>

                <p className="text-gray-400 text-[15px] sm:text-base leading-relaxed max-w-2xl">
                  Применяется на объектах промышленного и гражданского строительства для
                  снижения теплопотерь, контроля образования конденсата и изоляции
              ...
              <div className="lg:col-span-6 xl:col-span-5">
                <div className="relative">
                  ...
                  >
                    ...
                    {/* Фото рулона */}
                    <img
                      src="https://cdn.poehali.dev/projects/666206ac-09b6-496e-92d3-ecbea5df546a/bucket/89ddc1a0-bc4e-4d72-8025-67618c660aa0.png"
...
export default RulonnayaIzolyaciyaPgs;