...
export const UmatexWiredMat100SizesSection = () => {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24">
        <div className="max-w-3xl">
          ...
          <p className="text-gray-300 text-[15px] sm:text-base leading-relaxed mt-6">
            Прошивной мат выпускается в нескольких вариантах толщины, ширины и длины. Конкретное
            сочетание размеров подбирается по конструкции объекта, требуемой толщине теплоизоляции
            и условиям монтажа.
          </p>
        </div>
        ...
        <div className="mt-6 flex items-start gap-3 rounded-sm border border-white/10 bg-white/[0.02] p-4">
          ...
          <p className="text-gray-400 text-[13px] leading-[1.6]">
            Точные сочетания толщины, ширины и длины зависят от исполнения и производственной
            размерной сетки. Доступность конкретного типоразмера необходимо подтверждать при
            подборе.
          </p>
        </div>
      </div>
...
export default UmatexWiredMat100SizesSection;
