...
const PANELS: Panel[] = [
  {
    ...
    icon: "Ruler",
    unit: "мм",
    values: ["20", "25", "30", "40", "50", "60", "80", "100"],
  ...
  },
  {
    ...
    icon: "MoveHorizontal",
    unit: "мм",
    values: ["2500", "3000", "4000", "5000", "6000", "8000", "9000", "10000"],
...
const COMBOS: { th: string; len: string }[] = [
  { th: "20 мм", len: "10000 мм" },
  { th: "25 мм", len: "9000 мм" },
  { th: "30 мм", len: "8000 мм" },
  { th: "40 мм", len: "6000 мм" },
  { th: "50 мм", len: "5000 мм" },
  { th: "60 мм", len: "4000 мм" },
  { th: "80 мм", len: "3000 мм" },
  { th: "100 мм", len: "2500 мм" },
];
...
export const LamellaMatSizesSection = () => {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24">
        <div className="max-w-3xl">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="cat-label text-orange-400/90">РАЗМЕРЫ МАТОВ</span>
          </div>
          <h2 className="cat-h2 text-white">
            Размеры <span className="text-orange-500">ЛАМЕЛЛА МАТ</span>
          </h2>
          <p className="text-gray-300 text-[15px] sm:text-base leading-relaxed mt-6">
            ЛАМЕЛЛА МАТ выпускается в рулонах шириной 1000 мм. Длина рулона зависит от толщины
            материала.
          </p>
        </div>
        ...
        <div className="mt-6 flex items-start gap-3 rounded-sm border border-white/10 bg-white/[0.02] p-4">
          ...
          <p className="text-gray-400 text-[13px] leading-[1.6]">
            Длина рулона уменьшается при увеличении толщины материала. Доступность конкретного
...
export default LamellaMatSizesSection;
