...
const GROUPS: Group[] = [
  {
    name: "Навивные цилиндры RWL 100 / RWL 150",
    ...
    note: "Для RWL 100 и RWL 150 доступность отдельных сочетаний внутреннего диаметра и толщины различается. Точный типоразмер необходимо подтверждать при подборе материала.",
  },
  {
    name: "Цилиндры HOTPIPE SP 100",
    desc: "Цилиндры HOTPIPE выпускаются в расширенном диапазоне размеров. Конкретное исполнение подбирается по диаметру трубопровода, толщине теплоизоляции, типу покрытия и условиям монтажа.",
    panels: [
      {
