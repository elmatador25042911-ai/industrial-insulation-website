...
const PANELS: Panel[] = [
  ...
  },
  {
    ...
    icon: "MoveHorizontal",
    unit: "мм",
    values: ["2000", "4000", "4500", "5000", "6000", "7000"],
    grid: "grid-cols-3 sm:grid-cols-3",
    span: "md:col-span-3",
  },
  {
...
const COMBOS: { th: string; len: string }[] = [
  ...
  { th: "60 мм", len: "4500 мм" },
  { th: "70 мм", len: "4000 мм" },
...
export const WiredMat50SizesSection = () => {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24">
        <div className="max-w-3xl">
          ...
          <h2 className="cat-h2 text-white">
            Размеры <span className="text-orange-500">ВАЙРЕД МАТ 50</span>
          </h2>
          <p className="text-gray-300 text-[15px] sm:text-base leading-relaxed mt-6">
            ВАЙРЕД МАТ 50 выпускается в рулонах шириной 1000 мм. Длина рулона зависит от толщины
            материала.
          </p>
        </div>
        ...
        <div className="mt-6 flex items-start gap-3 rounded-sm border border-white/10 bg-white/[0.02] p-4">
          ...
          <p className="text-gray-400 text-[13px] leading-[1.6]">
            ...
            исполнения и покрытия необходимо подтверждать при подборе.
          </p>
        </div>
      </div>
    </section>
...
export default WiredMat50SizesSection;
