...
export const HotpipeSizesSection = () => {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24">
        <div className="max-w-3xl">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="cat-label text-orange-400/90">РАЗМЕРЫ ЦИЛИНДРОВ</span>
          </div>
          <h2 className="cat-h2 text-white">
            Размеры цилиндров{" "}
            <span className="text-orange-500">HOTPIPE SP 100</span>
          </h2>
          <p className="text-gray-300 text-[15px] sm:text-base leading-relaxed mt-6">
            Цилиндры HOTPIPE подбираются по диаметру трубопровода, толщине теплоизоляции, типу
            покрытия и условиям монтажа.
          </p>
        </div>
        ...
        <div className="mt-6 flex items-start gap-3 rounded-sm border border-white/10 bg-white/[0.02] p-4">
          ...
          <p className="text-gray-400 text-[13px] leading-[1.6]">
            Конкретные сочетания диаметра, толщины и длины зависят от исполнения цилиндра: без
            покрытия, с алюминиевой фольгой или с наружным защитным покрытием. Доступность
...
export default HotpipeSizesSection;
