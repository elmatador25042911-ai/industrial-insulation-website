...
const TABLES: Table[] = [
  {
    ...
    rows: [
      { temp: "50", value: "0,040" },
      { temp: "100", value: "0,048" },
      { temp: "150", value: "0,056" },
      { temp: "200", value: "0,068" },
      { temp: "250", value: "0,081" },
      { temp: "300", value: "0,096" },
      { temp: "350", value: "0,114" },
      { temp: "400", value: "0,132" },
      { temp: "500", value: "0,178" },
    ],
  },
  {
    name: "ВАЙРЕД МАТ 105",
    rows: [
      { temp: "50", value: "0,039" },
      { temp: "100", value: "0,045" },
      { temp: "125", value: "0,048", calc: true },
      { temp: "150", value: "0,052" },
      { temp: "200", value: "0,059" },
      { temp: "250", value: "0,068" },
      { temp: "300", value: "0,077" },
      { temp: "350", value: "0,089" },
      { temp: "400", value: "0,102" },
      { temp: "500", value: "0,132" },
    ],
  },
];
...
export const WiredMatThermalSection = () => {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24">
        <div className="max-w-3xl">
          ...
          <p className="text-gray-300 text-[15px] sm:text-base leading-relaxed mt-6">
            ...
            плотности прошивного мата. Значения приведены в Вт/(м·К).
          </p>
        </div>
        ...
        <div className="mt-6 flex items-start gap-3 rounded-sm border border-white/10 bg-white/[0.02] p-4">
          ...
          <p className="text-gray-400 text-[13px] leading-[1.6]">
            Значение ВАЙРЕД МАТ 105 при +125 °C является расчётным. Для окончательного
            теплотехнического расчёта необходимо учитывать рабочую температуру, монтажное
            уплотнение, толщину материала и условия эксплуатации.
          </p>
        </div>
      </div>
    </section>
...
export default WiredMatThermalSection;
