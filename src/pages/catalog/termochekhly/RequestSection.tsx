        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="text-gray-400 text-base sm:text-lg leading-[1.7] mb-10">
              Передайте параметры узла — тип оборудования, размеры, температурный
              режим, место установки, количество изделий и требования к
              обслуживанию. Подготовим расчёт термочехла ИТШМИ ПАНЦИРЬ по
              предоставленным данным.
            </p>

            <ul className="space-y-3.5 mb-10">
              {[
                "Подбор конструкции под форму узла",
                "Расчёт по температурному режиму и условиям эксплуатации",
                "Подготовка решения для съёмной изоляции оборудования",
              ].map((t) => (
              ...
              {submitted ? (
                ...
                <form
                  onSubmit={async (e) => {
                    ...
                    setLoading(true);
                    try {
                      await sendRequest({ ...data, source: "Термочехлы (судостроение)" });
                      setSubmitted(true);
                    } catch {
                ...
                >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Тип оборудования, размеры, температура, место установки, количество, сроки..."
                      rows={4}
