        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="text-gray-400 text-base sm:text-lg leading-[1.7] mb-10">
              Передайте параметры объекта — тип поверхности, толщину изоляции, требуемое покрытие,
              температурный режим, объём и условия эксплуатации. Подберём исполнение рулонной
              изоляции и подготовим расчёт по предоставленным данным.
            </p>

            {/* Что входит в работу */}
            <ul className="space-y-3.5 mb-10">
              {[
                "Подбор толщины и исполнения рулонной изоляции",
              ...
              {submitted ? (
                ...
                <form
                  onSubmit={async (e) => {
                    ...
                    setLoading(true);
                    try {
                      await sendRequest({ ...data, source: "Рулонная изоляция (судостроение)" });
                      setSubmitted(true);
                    } catch {
                ...
                >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Тип поверхности, толщина изоляции, покрытие, температурный режим, объём, сроки..."
                      rows={4}
                  ...
                  <p className="text-gray-500 text-[12px] text-center">
                    ...
                    <a href="/politika-konfidencialnosti#policy" className="underline hover:text-orange-400 transition-colors">
