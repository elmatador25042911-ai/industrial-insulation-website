...
const APPLICATIONS: { icon: string; title: string; text: string }[] = [
  {
    icon: "Wind",
    title: "Судовые воздуховоды",
    text: "Теплоизоляция воздуховодов и вентиляционных каналов судовых инженерных систем.",
  },
  {
    icon: "Snowflake",
    title: "Вентиляция и кондиционирование",
    text: "Изоляция участков систем вентиляции, кондиционирования и распределения воздуха.",
  },
  {
    icon: "Container",
    title: "Резервуары и ёмкости",
    text: "Изоляция поверхностей резервуаров, баков и технологических ёмкостей на судах и береговых объектах.",
  },
  {
    icon: "CircleDot",
    title: "Трубопроводы большого диаметра",
    text: "Применение на участках трубопроводов, где удобнее использовать рулонный материал вместо трубной изоляции.",
  },
  {
    icon: "Cog",
    title: "Машинные и котельные отделения",
    text: "Изоляция инженерных поверхностей в зонах повышенных температур, вибрации и эксплуатационных нагрузок.",
  },
  {
    icon: "Anchor",
    title: "Верфи, доки, судоремонт",
    text: "Применение при строительстве, ремонте, переоборудовании и обслуживании судов.",
  },
];
