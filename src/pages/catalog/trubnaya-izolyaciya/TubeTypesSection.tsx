...
const TUBE_TYPES: TubeType[] = [
  {
    ...
    img: "stdAngle01",
    properties: [
      "Работа в диапазоне температур от −200 до +110 °C",
      "Закрытая ячеистая структура — не впитывает влагу",
      "Эластичность и гибкость при монтаже",
      "Стабильная геометрия после установки",
    ],
    applications: [
      "Отопление",
  ...
  },
  {
    ...
    img: "cmAngle01",
    properties: [
      "Защита трубопроводов от конденсата и коррозии под изоляцией",
      "Закрытая ячеистая структура — не впитывает влагу",
      "Самоклеящийся слой для монтажа без дополнительного клея",
  ...
  },
  {
    ...
    properties: [
      ...
      "Отражение УФ-излучения",
      "Применение на открытых участках трасс",
    ],
  ...
  },
  {
    ...
    properties: [
      ...
      "Стойкость к механическим, химическим воздействиям и влаге",
    ],
  ...
  },
  {
    ...
    properties: [
      "Повышенная механическая прочность покрытия",
      "Низкая дымообразующая способность",
      "Сохранение эластичности в широком диапазоне температур",
  ...
  },
  {
    ...
    properties: [
      "Стойкость к повышенным температурам",
      "Низкая дымообразующая способность",
      "Стойкость к маслам и нефтепродуктам",
      "Отражающий слой алюминиевой фольги",
    ],
    applications: [
      "Теплотрассы",
      "Танкеры",
    ...
    <section className="relative overflow-hidden border-t border-white/5">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24">
        <div className="flex items-center gap-3 mb-3">
          ...
          <span className="cat-label text-orange-400/90">КАТАЛОГ ТИПОВ</span>
        </div>
        <h2 className="cat-h2 text-white mb-12 max-w-3xl">
          Типы <span className="text-orange-500">изоляционных трубок</span>
        </h2>
