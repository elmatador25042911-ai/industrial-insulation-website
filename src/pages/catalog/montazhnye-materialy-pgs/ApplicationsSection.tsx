...
const APPLICATIONS: Application[] = [
  {
    ...
    icon: "Pipette",
    text: "Склеивание продольных и поперечных стыков трубной изоляции при монтаже на трубопроводах.",
  },
  {
  ...
  },
  {
    ...
    icon: "Anchor",
    text: "Использование на промышленных объектах при строительстве, ремонте и обслуживании инженерных систем.",
  },
];
