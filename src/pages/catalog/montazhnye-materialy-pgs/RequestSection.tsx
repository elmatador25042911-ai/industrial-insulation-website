        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5">
            ...
            <h2 className="cat-h2 text-white mb-6 max-w-3xl">
              Подбор монтажных материалов под{" "}
              <span className="text-orange-500">теплоизоляцию объекта</span>
            </h2>
            <p className="text-gray-400 text-base sm:text-lg leading-[1.7] mb-10">
              Для подбора монтажных материалов передайте параметры объекта: тип теплоизоляции,
              материал основания, условия эксплуатации, объём работ, требования к склеиванию,
              герметизации и наружной защите стыков.
            </p>

            <ul className="space-y-3.5 mb-10">
              {[
                "Подбор клеевых составов и очистителей",
                "Подбор лент и материалов для обработки стыков",
                "Комплектация под параметры объекта",
              ].map((t) => (
              ...
              {submitted ? (
                ...
                <form
                  onSubmit={async (e) => {
                    ...
                    setLoading(true);
                    try {
                      await sendRequest({ ...data, source: "Монтажные материалы (ПГС)" });
                      setSubmitted(true);
                    } catch {
                ...
                >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Тип изоляции, покрытие, объём работ, условия эксплуатации, сроки..."
                      rows={4}
