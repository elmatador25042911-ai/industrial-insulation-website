    ...
    <section className="relative overflow-hidden border-t border-white/5">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24">
        <div className="flex items-center gap-3 mb-3">
          ...
          <span className="cat-label text-orange-400/90">ПАРАМЕТРЫ</span>
        </div>
        ...
        <div className="mt-12 flex items-start gap-3 max-w-3xl">
          ...
          <p className="text-gray-500 text-[13.5px] sm:text-sm leading-[1.7]">
            Монтажные материалы подбираются под тип теплоизоляции, материал основания, условия
            эксплуатации, влажность среды, требования к герметизации стыков и наружной защите
            изоляционного слоя.
          </p>
        </div>
      </div>
