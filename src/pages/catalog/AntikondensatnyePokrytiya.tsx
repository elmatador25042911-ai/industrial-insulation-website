...
const BADGES = [
  { icon: "ShieldCheck", text: "ЗМ.ПАНЦИРЬ.АК" },
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 lg:pt-32 pb-20 sm:pb-24 lg:pb-28">
            ...
            <div className="flex items-center gap-3 mb-8 flex-wrap">
              ...
              <span className="t-label text-orange-400/90 tracking-[0.18em] leading-relaxed">
                КАТАЛОГ / СУДОСТРОЕНИЕ / АНТИКОНДЕНСАТНЫЕ ПОКРЫТИЯ
              </span>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
              {/* Текст */}
              <div className="lg:col-span-6 xl:col-span-7 order-2 lg:order-none">
                <h1
                ...
                <p className="text-gray-200 text-lg sm:text-xl leading-relaxed max-w-2xl mt-7">
                  Защитное покрытие для снижения образования конденсата на
                  трубопроводах, оборудовании и металлических поверхностях в
                  судовых технических помещениях.
                </p>
              ...
              {/* Изображение */}
              <div className="lg:col-span-6 xl:col-span-5 order-1 lg:order-none">
                <div className="relative">
                  ...
                  >
                    <img
                      src={HERO_IMG}
                      alt="Антиконденсатное покрытие ЗМ.ПАНЦИРЬ.АК"
                      loading="eager"
...
export default AntikondensatnyePokrytiya;
