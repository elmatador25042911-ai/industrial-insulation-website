        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="text-gray-400 text-base sm:text-lg leading-[1.7] mb-10">
              Передайте параметры объекта — тип изоляции, наружное покрытие, участки монтажа,
              объём работ и условия эксплуатации. Подберём комплект монтажных материалов: клей,
              очиститель и стыковочные ленты под выбранное исполнение теплоизоляции.
            </p>

            <ul className="space-y-3.5 mb-10">
              {[
                "Подбор клея и очистителя для монтажа",
                "Подбор стыковочных лент под наружное покрытие",
                "Расчёт комплекта по параметрам объекта",
              ].map((t) => (
              ...
              {submitted ? (
                ...
                <form
                  onSubmit={async (e) => {
                    ...
                    setLoading(true);
                    try {
                      await sendRequest({ ...data, source: "Монтажные материалы (судостроение)" });
                      setSubmitted(true);
                    } catch {
