...
import UmatexThermalSection from "./kamennaya-vata-pgs/UmatexThermalSection";
import ApplicationsSection from "./kamennaya-vata-pgs/ApplicationsSection";
import RequestSection from "./kamennaya-vata-pgs/RequestSection";
...
import WiredMat105SizesSection from "./kamennaya-vata-pgs/WiredMat105SizesSection";
import UmatexWiredMat100SizesSection from "./kamennaya-vata-pgs/UmatexWiredMat100SizesSection";
  ...
  return (
    <InternalLayout>
      <main className="min-h-screen bg-[#0a0a0a] text-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-6 xl:col-span-7">
                ...
                <p className="text-gray-200 text-lg sm:text-xl leading-relaxed max-w-2xl mt-7 mb-5">
                  Теплоизоляционные цилиндры и маты из каменной ваты для промышленных и
                  технологических трубопроводов, оборудования, инженерных систем зданий,
                  вентиляции и поверхностей сложной формы.
                </p>

                <p className="text-gray-400 text-[15px] sm:text-base leading-relaxed max-w-2xl">
                  Материалы применяются для снижения теплопотерь, защиты конструкций при высоких
                  температурах, теплоизоляции оборудования и повышения пожарной безопасности
                  инженерных систем.
                </p>
              ...
              <div className="lg:col-span-6 xl:col-span-5">
                <div className="relative">
                  ...
                  >
                    ...
                    {/* Фото — временное изображение каменной ваты */}
                    <img
                      src={HERO_IMG}
                      alt="Каменная вата — цилиндры и маты для технической изоляции"
                  ...
                  <div className="mt-4 flex items-center gap-3 text-[12px] tracking-[0.18em] text-gray-500 uppercase">
                    ...
                    <span>T1 ИЗОЛЯЦИЯ / КАМЕННАЯ ВАТА</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <WiredMat105SizesSection />
        <UmatexWiredMat100SizesSection />
        <RequestSection />
      </main>
    </InternalLayout>
  );
...
export default KamennayaVataPgs;