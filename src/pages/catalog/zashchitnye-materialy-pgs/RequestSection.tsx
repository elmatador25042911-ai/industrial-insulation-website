        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="text-gray-400 text-base sm:text-lg leading-[1.7] mb-4">
              Передайте параметры объекта: тип изоляции, место монтажа, условия эксплуатации,
              наличие влаги, ультрафиолета, осадков, механических нагрузок и требования к
            ...
            <ul className="space-y-3.5 mb-10">
              {[
                "Подбор типа защитного материала под условия эксплуатации",
                "Подбор подходящего исполнения и состава поставки",
                "Расчёт и консультация по параметрам объекта",
              ].map((t) => (
              ...
              {submitted ? (
                ...
                <form
                  onSubmit={async (e) => {
                    ...
                    setLoading(true);
                    try {
                      await sendRequest({ ...data, source: "Защитные материалы (ПГС)" });
                      setSubmitted(true);
                    } catch {
                ...
                >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Тип изоляции, место монтажа, условия эксплуатации, влага, УФ, осадки, механические нагрузки..."
                      rows={4}
