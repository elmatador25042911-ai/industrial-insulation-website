        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5">
            ...
            <h2 className="cat-h2 text-white mb-6 max-w-3xl">
              Запросить подбор опор и подвесов{" "}
              <span className="text-orange-500">под объект</span>
            </h2>
            <p className="text-gray-400 text-base sm:text-lg leading-[1.7] mb-10">
              Передайте параметры трубопровода — диаметр, температурный режим,
              тип крепления, место установки и количество узлов. Подготовим
              подбор опор СОП «ПЕРИМЕТР» и подвесов XOTPIPE / ХОТПАЙП по предоставленным
              данным.
            </p>

            <ul className="space-y-3.5 mb-10">
              {[
                "Подбор опор и подвесов под диаметр трубопровода",
                "Учёт температурного режима и условий эксплуатации",
                "Предотвращение «мостиков холода» и разгрузка теплоизоляции",
              ].map((t) => (
              ...
              {submitted ? (
                ...
                <form
                  onSubmit={async (e) => {
                    ...
                    setLoading(true);
                    try {
                      await sendRequest({ ...data, source: "Опоры и подвесы (ПГС)" });
                      setSubmitted(true);
                    } catch {
                ...
                >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Диаметр трубопровода, температура, тип крепления, место установки, количество узлов, сроки..."
                      rows={4}
