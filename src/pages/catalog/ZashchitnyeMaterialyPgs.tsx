...
import ApplicationsSection from "./zashchitnye-materialy-pgs/ApplicationsSection";
import RequestSection from "./zashchitnye-materialy-pgs/RequestSection";
...
const BADGES = [
  ...
  { icon: "FileBadge", text: "ТУ 25.99.29-001-85495285-2019" },
];

const ZashchitnyeMaterialyPgs = () => {
  return (
    <InternalLayout>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 lg:pt-32 pb-20 sm:pb-24 lg:pb-28">
            ...
            <div className="flex items-center gap-3 mb-8 flex-wrap">
              ...
              <span className="cat-label text-orange-400/90 leading-relaxed">
                КАТАЛОГ / ПРОМЫШЛЕННОЕ И ГРАЖДАНСКОЕ СТРОИТЕЛЬСТВО / ЗАЩИТНЫЕ МАТЕРИАЛЫ
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-6 xl:col-span-7">
                ...
                <p className="text-gray-200 text-lg sm:text-xl leading-relaxed max-w-2xl mt-7 mb-5">
                  Покровные защитные материалы и металлические окожушки для наружной защиты
                  теплоизоляции на инженерных системах зданий, промышленных объектах,
                  трубопроводах, воздуховодах и оборудовании.
                </p>

                <p className="text-gray-400 text-[15px] sm:text-base leading-relaxed max-w-2xl">
                  Материалы применяются для защиты теплоизоляционных и шумоизоляционных
                  конструкций от механических повреждений, влаги, атмосферных осадков,
                  ультрафиолета и внешних эксплуатационных воздействий.
                </p>
              ...
              <div className="lg:col-span-6 xl:col-span-5">
                <div className="relative">
                  ...
                  >
                    ...
                    {/* Фото — временное изображение защитного покрытия / металлической оболочки */}
                    <img
                      src={coveringImages.metallSheetAngle01}
                      alt="Защитные материалы — металлическая окожушка"
                  ...
                  <div className="mt-4 flex items-center gap-3 text-[12px] tracking-[0.18em] text-gray-500 uppercase">
                    ...
                    <span>T1 ИЗОЛЯЦИЯ / ЗАЩИТНЫЕ МАТЕРИАЛЫ</span>
                  </div>
                </div>
              </div>
            </div>
...
export default ZashchitnyeMaterialyPgs;