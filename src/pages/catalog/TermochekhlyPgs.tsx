          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 lg:pt-32 pb-20 sm:pb-24 lg:pb-28">
            ...
            <div className="flex items-center gap-3 mb-8 flex-wrap">
              ...
              <span className="cat-label text-orange-400/90 leading-relaxed">
                КАТАЛОГ / ПРОМЫШЛЕННОСТЬ И ПГС / ТЕРМОЧЕХЛЫ
              </span>
            </div>
              ...
              <div className="lg:col-span-6 xl:col-span-7">
                <h1 className="cat-h1 text-white">
                  ...
                  <span className="text-orange-500">
                    для промышленности и гражданского строительства
                  </span>
                </h1>
                ...
                <p className="text-gray-200 text-lg sm:text-xl leading-relaxed max-w-2xl mt-7 mb-5">
                  ...
                  соединений, клапанов, оборудования и трубопроводных узлов котельных,
                  тепловых пунктов, заводов и инженерных систем зданий.
                </p>

                <p className="text-gray-400 text-[15px] sm:text-base leading-relaxed max-w-2xl">
                  Термочехлы изготавливаются под конкретный узел и применяются на объектах
                  промышленного и гражданского строительства для снижения теплопотерь,
                  защиты персонала от горячих поверхностей, ограничения шума и обслуживания
                  оборудования без демонтажа постоянной изоляции.
                </p>
...
export default TermochekhlyPgs;
